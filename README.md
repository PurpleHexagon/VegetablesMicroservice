# Censornet coding test docs

## Setup and running

The web application can be run locally via docker and docker-compose.

```bash
docker-compose up
```

List vegetables will now be available at http://0.0.0.0:8000/vegetables

To run the command line application:

```bash
docker exec -it censornet-app bash
```
...
You can use the command line application to seed the database with vegetables and list vegetables;
...
that for simplicity you stick to PSR-12 coding standards and PSR-4 for ease of autoloading.
